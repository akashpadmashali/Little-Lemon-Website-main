  ...
  return (
    ...
    <footer>
      ...
      <div className="flex flex-col md:flex-row py-[15px] md:pt-[40px] items-center justify-around bg-Pgreen w-full space-y-[10px] md:space-y-0">
        ...
        <h4 className=" text-start md:hidden  right-[30px] font-primary   mb-[10px] text-Swhite text-[20px] ">
          Contact Us
        </h4>
        {/* flex container for footer element columns */}
        <div className="flex flex-row md:flex-col -mt-[50px] space-x-[10px] md:space-x-0">
          <h4 className="hidden md:block text-start   right-[30px] font-primary  -mt-[10px] mb-[10px] text-Swhite text-[20px] ">
            Contact Us
          </h4>
        ...
        <h4 className=" md:hidden text-start md:block  right-[30px] font-primary  -mt-[10px] mb-[10px] text-Swhite text-[20px] ">
          Social Medias
        </h4>
        <div className="flex flex-row md:flex-col -mt-[50px] space-x-[10px] md:space-x-0">
          <h4 className=" hidden text-start md:block  right-[30px] font-primary  -mt-[10px] mb-[10px] text-Swhite text-[20px] ">
            Social Medias
          </h4>
