...
export default function TestimonialCard(props) {
  return (
    ...
    <div
      className={`${props.visibality} md:${props.visibalityMd} lg:${props.visibalityLg} xlg:${props.visibalityMd} xl:flex bg-Swhite from-Lyellow relative to-Lgreen  md:flex flex-col flex-wrap border-black w-[300px]  drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]  rounded-lg h-[300px] md:h-[280px] px-[48px] py-[30px]`}
    >
