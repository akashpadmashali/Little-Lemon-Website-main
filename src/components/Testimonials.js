...
export default function Testimonials() {
  return (
    <section id="testiomonials">
      ...
      <div className=" relative  mx-auto  lg:mt-[5px]  rounded-md bg-gradient-to-r from-Lyellow to-Pgreen w-[100%] p-10">
        <h1 className="font-primary -mt-[30px] -mb-[25px] text-white y text-[50px] md:text-[50px] w-[100%] text-center drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]">
          Testemionials
        </h1>
        <button variant="contained">
          <h1 className="absolute text-end  hover:underline hover:text-Pyellow top-[20px] right-[20px]  md:top-[40px] md:right-[30px] font-primary  -mt-[10px] mb-[10px] text-white text-[20px] md:text-[25px] ">
            More
          </h1>
        </button>
